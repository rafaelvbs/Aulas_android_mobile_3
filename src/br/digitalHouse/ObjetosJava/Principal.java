...
public class Principal {
    ...
    public static void main(String[] args){
        ...
        Animal animalDomestico=new Animal(); // ctrl+P dentro de parenteses mostra qual parametro aceita?
        animalDomestico.setNomeAnimal("Ted");
        System.out.println(animalDomestico.getNomeAnimal());


     Pessoa pessoaJovem =new Pessoa("Erica");
        System.out.println(pessoaJovem.getNomePessoa());

        System.out.println(animalDomestico.getDonoAnimal().getNomePessoa());//entender isso?
    }
